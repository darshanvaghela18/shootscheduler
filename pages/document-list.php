...
<head>
    ...
    <title>Project List - Document Management</title>
...
<body>
    ...
    <main>
        <section class="project-list">
            <h2>Select Project for Document Management</h2>
                    ...
                    <tbody>
                        <?php while ($project = $projects_result->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="document-management.php?project_id=<?php echo $project['id']; ?>" class="view">Manage Documents</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
